...
import { selectAllOrders } from "@productize-v1.0.0/modules/shared/redux";
...
const LineChart = () => {
    ...
    // useEffect(() => {
    //     console.log(tuesdayOrders);
    //     console.log(averageRevenuePerWeek(tuesdayOrders));
    //     console.log(revenueDataSet);
    // }, [averageRevenuePerWeek, revenueDataSet, tuesdayOrders]);
                ...
                datasets: [
                    {
                        ...
                        data: revenueDataSet,
                        // data: [7010, 500, 1000, 1500, 2000, 0, 2500],
                        // fill: true,
                        borderColor: `#0266F4`,
                    },
                ],
