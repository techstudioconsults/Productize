...
export const NewProductTabLayout = () => {
  ...
  const handlePublishAction = async () => {
    ...
    try {
      ...
      toastIdRef.current = toast({
        position: 'top',
        render: () => <ToastFeedback message={errorMessage} title={errorMessage} icon={errorImg} color="red.600" btnColor="red.600" handleClose={close} />,
      });
    }
    // }
  };
  ...
  return (
    <FormProvider {...methods}>
      <Tabs index={tabIndex} onChange={(index) => setTabIndex(index)} size={`sm`}>
        ...
        >
          <Flex>
            <Tab id="product-details" py={6} mb={0} w={{ base: '10rem', sm: 'initial' }} isDisabled _disabled={disabledStateStyle} _selected={activeStateStyle}>
              Product Details
            </Tab>
            <Tab id="preview" py={6} mb={0} w={{ base: '10rem', sm: 'initial' }} isDisabled _disabled={disabledStateStyle} _selected={activeStateStyle}>
              Preview
            </Tab>
            {/* <Tab
                            id="preview"
            ...
            <Tab id="share" py={6} mb={0} w={{ base: '10rem', sm: 'initial' }} isDisabled _disabled={disabledStateStyle} _selected={activeStateStyle}>
              Share
            </Tab>
          </Flex>
