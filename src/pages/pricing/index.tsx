...
import { AccordionComponent, Hero, SectionLayout, SharedSection } from '@productize-v1.0.0/modules/external-pages/ui';
import { PricingCard, SharedButton } from '@productize-v1.0.0/modules/shared/ui';
