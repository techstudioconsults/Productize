        ...
        <DefaultLayout>
                ...
                <Stack gap={10}>
                    <Container zIndex={3} color={`yellow.300`} mt={`10rem`} textAlign={`center`} maxW={`70rem`}>
                        ...
                        <Text as={`h5`} fontWeight={300} maxW={`70rem`} margin={`auto`} mt={3}>
                            ByteAlley looks out for a better life with a money making system, no monthly charges. Just
                            for you
                        </Text>
                    </Container>
                    ...
                    <Container maxW={`35rem`} px={{base: 4, xl: 0}} pr={{base: 4, xl: 16}}>
                        ...
                        <Flex flexDirection={`column`} gap={`0.9rem`}>
                            <Text textAlign={{base: 'center', xl: 'left'}} fontSize={{base: '1.2rem', xl: '1.5rem'}}>
                                ByteAlley began with a simple idea: to create a platform where digital creators could
                                easily share their products with the
                                world.
                            </Text>
                            <Text textAlign={{base: 'center', xl: 'left'}} pb={'0.7rem'}
                                  fontSize={{base: '1.2rem', xl: '1.5rem'}}>
                                Founded by a team of tech enthusiasts and digital innovators, we set out to empower
                                individuals to turn their creative ideas
            ...
            <Container maxW={'71rem'} py={'3.5rem'} px={{base: '1rem', lg: '1rem'}}>
                ...
                <SimpleGrid flex={2} columns={{base: 1, sm: 2}} spacing={10}>
                    {/* card 1 */}
                    <Box>
                        <CardLayout border={'2px'} bgColor={'white'} width={'100%'} borderRadius={'16px'}
                                    height={`100%`}>
                            <CardBody p={`23px`}>
                                ...
                                <Text color={`grey.500`}>Sell a variety of digital products, including courses, eBooks,
                                    software, music, and more. Customize your product pages with detailed descriptions,
                                    multimedia, and personalized settings.</Text>
                            </CardBody>
                        </CardLayout>
                    </Box>
                    {/* card 2 */}
                        ...
                        <CardLayout border={'2px'} bgColor={'white'} width={'100%'} borderRadius={'16px'}
                            ...
                            <CardBody p={`23px`}>
                                ...
                                <Text fontWeight={400} color={`grey.500`} as={`h6`}>
                                    Leverage our built-in affiliate marketing features to expand your product reach.
                                    Collaborate with affiliates who promote your products in exchange for commissions.
                                </Text>
                            </CardBody>
                        </CardLayout>
                    </Box>
                    ...
                    <Box>
                        <CardLayout border={'2px'} bgColor={'white'} width={'100%'} borderRadius={'16px'}
                            ...
                            <CardBody p={`23px`}>
                                ...
                                <Text fontWeight={400} color={`grey.500`} as={`h6`}>
                                    Our platform ensures secure and seamless transactions, giving both sellers and
                                    buyers peace of mind. Our commitment to security extends to regular audits and
                    ...
                    <Box>
                        <CardLayout border={'2px'} bgColor={'white'} width={'100%'} borderRadius={'16px'}
                            ...
                            <CardBody p={`23px`}>
                                ...
                                <Text fontWeight={400} color={`grey.500`} as={`h6`}>
                                    Join a vibrant community of creators and entrepreneurs. Share insights and learn
                                    from others’ experiences. Our platform fosters an environment of innovation, where
                                    you can network with like-minded individuals
                                </Text>
                            </CardBody>
                        </CardLayout>
                    </Box>
