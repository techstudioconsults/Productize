...
import { selectPaginationMetaData, useGetLiveProductsMutation } from '@productize/redux';
...
export const LiveTable = ({ draft, live, deleted, tableData }: tableProps) => {
    ...
    const handlePrevButton = () => {
        getLiveProducts({ link: paginate?.links?.prev }).unwrap();
    };

    const handleNextButton = () => {
        getLiveProducts({ link: paginate?.links?.next }).unwrap();
    };
