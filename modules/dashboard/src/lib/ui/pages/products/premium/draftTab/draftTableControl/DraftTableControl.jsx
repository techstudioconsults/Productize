...
import { useDraftTableControl } from './service';

export const DraftTableControl = ({ showRefreshBtn }) => {
    const { exportLoading, getDraftProductsStatus, handleExport, handleDateRangeChange, filterTable } = useDraftTableControl();
