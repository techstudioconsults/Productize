                ...
                <Box my={ 8 }>
                    <Flex flexDir={ { base:`column`, lg:`row` } } alignItems={ `flex-start` } justifyContent={ `space-between` } gap={ 5 }>
                        <Box>
                            ...
                            <FormHelperText fontSize={ { base:`xs`, md:`sm` } } color={ `grey.400` }>
                                Upload the photos to promote your product, a maximum of 4 photos. Images should be horizontal, at least 1280x720px,
                                and 72 DPI
                                (dots per inch)
                            </FormHelperText>
                            <Text className={ `tiny-text` } color={ `red.200` }>
...
const CoverPhotoThumbnailActiveContent = ( { file } ) => {
    return (
        <Card maxW={ `368px` } w={ `100%` } minH={ `200px` } h={ `100%` } borderRadius={ `5px` } variant={ `outline` } border={ `5px solid #F3F2FB` }
              overflow={ `hidden` }>
