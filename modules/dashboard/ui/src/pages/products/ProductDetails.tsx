...
import { useGetSingleProductDetailsMutation, useDeleteProductSoftlyMutation, useUpdateProductStatusMutation, selectSingleProduct } from '@productize-v1.0.0/modules/shared/redux';
...
export const ProductDetails = () => {
	...
	const [getSingleProduct, singleProductStatus] =
				...
				>
					...
					<Stack gap={2}>
						...
						{singleProductStatus.isLoading ? (
							...
							<Tag
								colorScheme={
									product?.status === `published` ? `green` : `yellow`
								}
								size={`lg`}
							>
								{product?.status}
